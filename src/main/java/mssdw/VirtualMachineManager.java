 ...
 * {@link mssdw.connect.Connector} objects. Each connector encapsulates
 ...
 * Some {@link mssdw.connect.Connector} implementations may require slightly
 ...
 * {@link mssdw.connect.LaunchingConnector#launch(java.util.Map)}
 ...
 * {@link mssdw.connect.Connector#defaultArguments()}) to the end user,
 * allowing the user to
 * fill in the transport-specific address generated by the target VM.
 * <LI>
 * Debugger calls the {@link mssdw.connect.AttachingConnector#attach(java.util.Map)} method
 ...
 * transports.</LI>
 * <LI>
 * Debugger calls the {@link mssdw.connect.ListeningConnector#startListening(java.util.Map)} method for each selected
 ...
 * <LI>
 * Debugger calls
 * {@link mssdw.connect.ListeningConnector#accept(java.util.Map)}
 ...
 * {@link mssdw.connect.ListeningConnector#accept(java.util.Map)} for that
 * transport.</LI>
 * <LI>
 * Debugger's call to {@link mssdw.connect.ListeningConnector#accept(java.util.Map)} returns
 ...
 * {@link mssdw.connect.Connector#defaultArguments()}) to specify
 ...
 * <LI>
 * Debugger calls the
 * {@link mssdw.connect.AttachingConnector#attach(java.util.Map)} method
 * of the selected to attach to the target VM. A {@link VirtualMachine}
 * mirror is returned.
 * </TD>
 * </TR>
 ...
 * {@link mssdw.connect.spi.TransportService} implementations
 ...
 * the {@link mssdw.connect.Connector} type,
 ...
 * {@link mssdw.connect.Connector Connector} interface. More
 * appropriately the class implements one of the specific Connector
 * types, namely {@link mssdw.connect.AttachingConnector
 * AttachingConnector}, {@link mssdw.connect.ListeningConnector
 * ListeningConnector}, or {@link mssdw.connect.LaunchingConnector
 ...
 * any {@link mssdw.connect.spi.TransportService} implementations
 ...
 * {@link mssdw.connect.spi.TransportService} type, and that jar
 ...
 * sub-class of {@link mssdw.connect.spi.TransportService
 ...
 * {@link mssdw.connect.AttachingConnector} and
 * {@link mssdw.connect.ListeningConnector}. These
 * Connectors are created to encapsulate a {@link
 * mssdw.connect.Transport Transport} that in turn
 ...
 * mssdw.connect.spi.TransportService#name() name()} method
 ...
 * mssdw.connect.Connector#description() description()} method
 * of both the AttachingConnector, and the ListeningConnector, will
 * delegate to the {@link mssdw.connect.spi.TransportService#description()
...
public interface VirtualMachineManager
{
	 ...
	 * for which a {@link mssdw.connect.spi.Connection Connection}
	 * already exists. A Connection is created when a {@link
	 * mssdw.connect.Connector Connector} establishes
	 ...
	 * @see mssdw.connect.spi.Connection#isOpen()
