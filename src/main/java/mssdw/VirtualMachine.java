 ...
 * {@link mssdw.connect.Connector}. For example,
 * an {@link mssdw.connect.AttachingConnector AttachingConnector}
 ...
 * guaranteed to be stable until after the {@link mssdw.event.VMStartEvent} has been
 * received.
 * <p/>
 ...
 * available to be read from the {@link mssdw.event.EventQueue}.
 * <p/>
 * Any method on <code>VirtualMachine</code> which
 * takes <code>VirtualMachine</code> as an parameter may throw
