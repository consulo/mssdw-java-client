 ...
 * mssdw.connect.spi.TransportService TransportService}
 * implementations this exception is thrown when
 * {@link mssdw.connect.spi.TransportService#attach attach}
 * times out when establishing a connection to a target VM,
 * or {@link mssdw.connect.spi.TransportService#accept
 * accept} times out while waiting for a target VM to connect. </p>
 *
 * @see AttachingConnector#attach
 * @see ListeningConnector#accept
 * @see mssdw.connect.spi.TransportService#attach
 * @see mssdw.connect.spi.TransportService#accept
 *
 * @since 1.5
 */
