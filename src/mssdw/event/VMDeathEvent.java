 ...
 * {@link mssdw.VirtualMachine#dispose()
 *      VirtualMachine.dispose()}
 * <P>
 * On VM termination, a single unsolicited VMDeathEvent
 * will always be sent with a
 * {@link mssdw.request.EventRequest#suspendPolicy() suspend policy}
 * of {@link mssdw.request.EventRequest#SUSPEND_NONE SUSPEND_NONE}.
 * Additional VMDeathEvents will be sent in the same event set if they are
 * requested with a
 * {@link mssdw.request.VMDeathRequest VMDeathRequest}.
 * <P>
 ...
 * @see mssdw.request.EventRequestManager#createVMDeathRequest
 * @see mssdw.request.VMDeathRequest
 * @see EventQueue
 * @see mssdw.VirtualMachine
 *
 * @author Robert Field
 * @since  1.3
 */
